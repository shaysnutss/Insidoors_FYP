...
# This notebook details the second iteration of using Local Outlier Factor to identify suspicious employee activity. For ease of development, all classifiers are currently built and trained in this notebook. When integrating with the main application, a separate executable script should be created for each classifier.
# 
# #### Changelog
# 
# *Version: 2 (Current)*
